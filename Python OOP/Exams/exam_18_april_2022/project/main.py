from project_10_april.movie_app import MovieApp
from project_10_april.movie_specification.fantasy import Fantasy
from project_10_april.movie_specification.action import Action
